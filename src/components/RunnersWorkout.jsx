...
const RunnersWorkout = () => {
  return (
    <div className="flex h-[210px] sm:h-[230px] md:h-[270px] lg:h-[300px]">
      <div className="hover:transition-all relative rounded-l-lg flex-1 hover:flex-[2]">
        <img
        ...
        <span className="text-lg text-white absolute top-4 right-4">
          <BsArrowRightCircleFill />
        </span>
      </div>

      <div className="hover:transition-all relative flex-1 hover:flex-[2]">
        <img
      ...
      <div className="hover:transition-all relative flex-1 hover:flex-[2] rounded-r-lg">
        <img
