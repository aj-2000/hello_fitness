...
const Navbar = () => {
  return (
    <div className="bg-white flex justify-between shadow-lg py-2 px-2 md:px-6">
      <div className="bg-black rounded-full text-white flex items-center">
        <IoIosFitness size={40}/>
      </div>
      <div className="px-2 flex gap-x-8 md:gap-x-16 lg:gap-x-20 items-center justify-between">
